...
category-item { text-align: center; cursor: pointer; transition: transform .18s ease, box-shadow .18s ease; } .category-item:focus, .category-item:hover { transform: translateY(-6px); text-decoration: none; } .avatar { width: 96px; /* Change size here */ height: 96px; display: inline-block; border-radius: 50%; overflow: hidden; box-shadow: 0 6px 18px rgba(20,20,30,0.08); border: 2px solid rgba(0,0,0,0.04); background: #f6f6f8; } .avatar img { width: 100%; height: 100%; object-fit: cover; } .category-title { margin-top: .5rem; font-size: .95rem; color: #222; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 110px; margin-left: auto; margin-right: auto; } /* optional small caption style */ .category-sub { font-size: .78rem; color: #6b7280; } /* responsive variants */ @media (min-width: 992px) { .avatar { width: 110px; height: 110px; } .category-title { max-width: 130px; } } /* keyboard focus outline */ .category-item:focus .avatar { outline: 3px solid rgba(99,102,241,0.15); outline-offset: 4px; }
</style>
...
<div class="min-vh-100 bg-light">
    ...
    <h3 class="mb-4 fw-bold">Categories</h3>
    <div class="row g-4">
          <div class="col-4 col-sm-3 col-md-2 d-flex justify-content-center">
            <a href="#breakfast-section" class="scroll-link category-item text-decoration-none">
                <div class="avatar">
                    <img src="{{ asset('public/images/8496222.jpg')}}" alt="Food">
                </div>
                <div class="category-title text-center">Food</div>
            </a>
        </div>
    ...
    <div class="container-fluid px-3 px-md-4 px-lg-5 mt-5">
        ...
        <div class="mb-5 scroll-offset" id="breakfast-section">
                ...
                <div class="space-y-4">
                    ...
                    @php
                        ...
                        if ($isToday && !$hideBreakfast) {
                            ...
                            // Hide tomorrow breakfast if current time is 10 PM or later
                            $hideBreakfast = $isTomorrow 
                                && $menu->meal_type === 'breakfast' 
                                && $currentHour >= 22 && !$isDayAfter;

                            $isMealAvailable = !$hideBreakfast;
                            $availabilityMessage = $hideBreakfast ? "Closed" : "Available";
                            $showCutoffTimer = !$hideBreakfast;
                        } else {
                            $isMealAvailable = false;
