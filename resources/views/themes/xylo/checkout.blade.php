                    ...
                    @foreach($cart as $key => $item)
                        ...
                        <div class="summary-item flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                <img src="{{ $variant && $variant->images && $variant->images->first() ? asset('/public/storage/'.$variant->images->first()->image_url) : ($product && $product->thumbnail ? asset('/public/'.$product->thumbnail->image_url) : 'https://via.placeholder.com/60x60') }}" 
