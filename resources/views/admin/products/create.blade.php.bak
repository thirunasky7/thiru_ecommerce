            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    ...
                    <select name="is_coming_soon" class="form-select"  required>
                        <option value="0" selected>{{ __('cms.products.no') }}</option>
                        <option value="1" {{ old('is_coming_soon') == '1' ? 'selected' : '' }}>{{ __('cms.products.yes') }}</option>
                    </select>
                </div>
            </div>
...
<div class="card p-3 mt-3 border rounded">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <select name="is_food_menu" class="form-select" id="isFoodMenu" required>
                <option value="no" selected>{{ __('cms.products.no') }}</option>
                <option value="yes" {{ old('is_food_menu') == 'yes' ? 'selected' : '' }}>{{ __('cms.products.yes') }}</option>
            </select>
        </div>
    </div>
...
$(document).ready(function () {
    // Check if there's old input for food menu
    @if(old('is_food_menu') === 'yes')
